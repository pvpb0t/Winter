...
public class DamageUtil {  public static int getRoundedDamage(ItemStack stack) {
    ...
    public static boolean canTakeDamage(boolean suicide) {
        return !Minecraft.getMinecraft().player.capabilities.isCreativeMode && !suicide;
    }
    ...
    public static float calculateDamage(double posX, double posY, double posZ, Entity entity) {
        ...
        if (entity instanceof EntityLivingBase) {
            finald = DamageUtil.getBlastReduction((EntityLivingBase) entity, DamageUtil.getDamageMultiplied(damage), new Explosion(Minecraft.getMinecraft().world, null, posX, posY, posZ, 6.0f, false, true));
        }
        return (float) finald;
    }
